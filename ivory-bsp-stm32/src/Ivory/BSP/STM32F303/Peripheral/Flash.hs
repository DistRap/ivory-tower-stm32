...
module Ivory.BSP.STM32F303.Peripheral.Flash
  ( Flash(..)
  , flash
  , module Ivory.BSP.STM32F303.Peripheral.Flash.Regs
  ) where

import Ivory.HW

import Ivory.BSP.STM32F303.Peripheral.Flash.Regs
import Ivory.BSP.STM32F303.MemoryMap (flash_r_periph_base)
